...
INSERT INTO tanaghom.app_users (id, email, display_name, kind, role)
VALUES ('00000000-0000-4000-8000-000000000001', 'owner@example.test', 'Staging Owner', 'human', 'owner');
