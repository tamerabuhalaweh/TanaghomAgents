# Department expansion: design, product and project-management teams
...
The approved all-department roadmap includes 22 source profiles across design, product, project-management. They are catalogued, not adapted, tested, available or activated. Extend organization planning, design/brand reviews, customer research synthesis and delivery coordination with attributable artifacts and explicit human decisions.

## User story

As an organization owner, I want extend organization planning, design/brand reviews, customer research synthesis and delivery coordination with attributable artifacts and explicit human decisions. with a clear capability boundary and no assumption that a role title grants authority.

## Scope

- Preserve coverage of all 22 pinned profiles in these divisions; the catalog is the authoritative per-profile checklist.
- Extend organization planning, design/brand reviews, customer research synthesis and delivery coordination with attributable artifacts and explicit human decisions.
- Required data: Approved product briefs, brand standards, authorized design artifacts and de-identified research/task records.
- Review risks: Unsupported research claims, invented customer evidence, copyrighted assets, inaccessible/localization-inappropriate designs, silent changes to release scope and manager-created permissions.
- Initial execution boundary: Research/design/planning proposals only initially. Brand review never replaces human publishing approval, and project managers cannot authorize execution or change other teams' policies.
...
- #178 bounded assignments
- #179 owner experience
- #155 existing content lineage
...
- [ ] All 22 assigned profiles have a reviewed disposition, primary delivery owner, source/skill versions, permissions, data classification, domain reviewer and next gate; none is silently omitted.
...
- [ ] Required representative cases include: Conflicting stakeholders, missing evidence, disputed scope, stale design versions, RTL/accessibility gaps, reused copyrighted material and overdue approval.
...
Versioned planning snapshot: docs/planning/agency-expansion/issues/dept_product.md. The snapshot is published through the planning documentation PR; issue/comment edits are not immutable release evidence.
