# Department expansion: academic and research teams
...
The approved all-department roadmap includes 7 source profiles across academic, research. They are catalogued, not adapted, tested, available or activated. Provide source-grounded research synthesis and educational/research assistance with reproducible references and explicit uncertainty.

## User story

As an organization owner, I want provide source-grounded research synthesis and educational/research assistance with reproducible references and explicit uncertainty. with a clear capability boundary and no assumption that a role title grants authority.

## Scope

- Preserve coverage of all 7 pinned profiles in these divisions; the catalog is the authoritative per-profile checklist.
- Provide source-grounded research synthesis and educational/research assistance with reproducible references and explicit uncertainty.
- Required data: Approved literature/documents/datasets with provenance, rights, freshness and access limits; external search requires a separately reviewed connector.
- Review risks: Invented citations/results, plagiarism, confidential research, unsafe experimental instructions, private-data exposure and unsupported domain conclusions.
- Initial execution boundary: Cited synthesis and draft artifacts first. No automatic external scraping, dataset publication, research submission or high-risk experiments; do not present generated analysis as verified empirical results.
...
- #136 any external research connector
- #137 evidence/certification
...
- [ ] Required representative cases include: Missing/contradictory source, malicious paper text, outdated source, unlicensed full-text request, false citation, unavailable data and English/Arabic evidence fidelity.
...
Use per-profile contract tests plus two-tenant authorization and adversarial tests, measured resource/latency limits, stop/replay/recovery evidence and qualified domain review where relevant. Missing/contradictory source, malicious paper text, outdated source, unlicensed full-text request, false citation, unavailable data and English/Arabic evidence fidelity. No live customer/provider activity is authorized by this planning issue.
...
Versioned planning snapshot: docs/planning/agency-expansion/issues/dept_research.md. The snapshot is published through the planning documentation PR; issue/comment edits are not immutable release evidence.
