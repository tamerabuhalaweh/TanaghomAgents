...
async function encryptedBacklogRestore(prefix) {
  ...
  assert.equal((await restorePool.query("SELECT version FROM public.schema_migrations ORDER BY version DESC LIMIT 1")).rows[0].version, "0020_quality_rollout_control");
