...
operator() { DATABASE_URL="$operator_url" TANAGHOM_EXPECTED_MIGRATION=0025_runtime_agent_reconciliation node "$package/scripts/reconcile-operator.mjs" "$1" "$campaign" "$job_id"; }
