...
read_optional_secret AGENCY_WORKSPACE_DATABASE_URL workspace_database_url
read_optional_secret AGENCY_WORKSPACE_WORKER_TOKEN workspace_worker_token
read_optional_secret GEMMA_API_KEY gemma_api_key
