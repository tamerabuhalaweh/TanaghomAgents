...
test "$(db_scalar "SELECT count(*) FROM tanaghom.external_operations;")" = 0 || die 'external operations exist; automatic data rollback is unsafe'
...
echo "PASS: Phase 5D transaction rolled back to $EXPECTED_START_MIGRATION and $expected_current."
