...
automatic_rollback() {
  ...
  if test "$failed" -ne 0; then
    ...
    echo 'ERROR: automatic rollback was incomplete; preserve all evidence and keep safety controls locked.' >&2
  fi
}
...
echo "PASS: Phase 7B Skill Library update committed. Evidence: $evidence"
