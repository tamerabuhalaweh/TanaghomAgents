...
grep -q 'container-exported, host-copied, audited, and transactionally removed exactly one inactive zero-execution shadow workflow' "$package/scripts/test-disposable-workflow-lifecycle.sh"
