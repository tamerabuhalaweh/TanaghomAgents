...
if (!["0023_campaign_lifecycle", "0024_conversation_intelligence_worker_registry", "0025_runtime_agent_reconciliation", "0026_skill_registry", "0027_governed_skill_library", "0028_strategy_cadence_integrity", "0029_organization_agent_studio", "0030_policy_resolved_agent_runtime"].includes(expectedMigration)) {
