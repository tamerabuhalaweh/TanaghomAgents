...
if (!["0023_campaign_lifecycle", "0024_conversation_intelligence_worker_registry", "0025_runtime_agent_reconciliation", "0026_skill_registry", "0027_governed_skill_library", "0028_strategy_cadence_integrity", "0029_organization_agent_studio", "0030_policy_resolved_agent_runtime", "0031_policy_runtime_executors_certification", "0032_gemma_served_model_profile", "0033_agent_runtime_certification_evidence"].includes(expectedMigration)) {
